...
<body>
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                ...
                <a href="index.html"><img src="logo-sekolah.png" style="float: left; padding-right: 15px;" alt=""
                        class="img-fluid"></a>
            </div>
            ...
            <div class="header-social-links d-flex align-items-center">
                ...
                <div style="display: block; padding: -20px 0px;">
                    ...
                    <p style="font-size: 13px;">#723613</p>
                </div>
                <img src="logo-sekolah.png" style="margin-left: 20px; width: 32px; float: right;" height="32px" alt="#">
            </div>
    ...
    <footer id="footer" style="height: 250px; clear: both; position: relative; margin-top: 280px;">
        ...
        <div class="footer-top" style="background-color: #e8fcff;">
            <div class="container">
                <div class="row">
