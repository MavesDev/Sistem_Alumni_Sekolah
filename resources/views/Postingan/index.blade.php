...
<div class="wrapper">
    <div style="margin: auto; width: 40rem" class="">
        <br>
        <h3>Postingan</h3>
        <a href="/posts/create" class="btn btn-outline-dark"><i class="fas fa-plus"> Tambah Postingan</i></a>
        <br><br>

        <!-- Mulai Card Postingan -->

        <div class="card" style="width: 40rem;">
            <div class="card-header">
                <button style="float: right; border-style: none; background: none;"><i class="fas fa-flag"></i></button>
                <button style="float: right; border-style: none; background: none;"><i class="fas fa-share"></i></button>
        ...
        <div class="card" style="width: 40rem;">
            ...
            <div class="wrapper">
                <img src="img/Postingan/post/{{ $post->post_image }}" class="card-img-top" style="display: block; margin: auto; width:16cm" alt="...">
                <div class="card-body">
                    <h5 class="card-title text-bold"><strong>{{ $post -> post_name }}</strong></h5>
                    <p class="card-text">{{ $post -> post_desc }} <span id="dots">...</span><span id="more">finibus semper orci. Orci varius natoque penatibus
                            et magnis dis parturient montes, nascetur
                            ridiculus mus. Aenean lacinia erat ut mollis tincidunt. Proin sodales consectetur aliquet.
                            Vivamus porta nunc at leo consequat, vitae pellentesque mauris rutrum. Nullam nec tristique
                            erat. Pellentesque elit nulla, cursus at enim quis, mollis feugiat ex. Nulla suscipit libero
