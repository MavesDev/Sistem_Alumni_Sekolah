...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="/home/{{ $beranda->id }}/editEvent" style="margin-bottom: 100px;">
        ...
        <div class="mb-3 col-6">
            ...
            <input type="text" class="form-control @error('event_name') is-invalid @enderror" id="event_name" name="event_name" aria-describedby="emailHelp" placeholder="Masukan nama acara" value="{{ $beranda->event_name }}">
            @error('event_name')
        ...
        <div class="mb-3 col-6">
            ...
            <input type="file" class="form-control" id="event_image" name="event_image" aria-describedby="emailHelp" placeholder="Masukan gambar acara" value="{{ $beranda->event_image }}">
            @error('event_image')
            <div id=" invalidCheck3Feedback" class="invalid-feedback">
                {{ $message }}
            </div>
