                    ...
                    <div class=" login-wrap py-5" style="background-color: #fff;">
                        ...
                        <form action="/register" class="login-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control @error('name') is-invalid @enderror" autocomplete="off" placeholder="Nama" name="name">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control @error('alumni-code') is-invalid @enderror" autocomplete="off" placeholder="NIS (9 Karakter)" name="alumni_code">
                                @error('alumni_code')
                                <div id="invalidCheck3Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control @error('alumni_domisil') is-invalid @enderror" autocomplete="off" placeholder="Domisili" name="alumni_domisil">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control @error('alumni_job') is-invalid @enderror" autocomplete="off" placeholder="Pekerjaan" name="alumni_job">
